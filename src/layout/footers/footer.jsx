...
import footer_logo from "../../../public/assets/img/logo/logo-white-tagline.svg";
...
const footer_content  = {
    ...
    phone: "+91(81056 43335)",
    contact_mail: "support@devtekai.com",
    location: "27-175, Lane 3, SSN, Bairagiguda, Hyderabad, India, 500091",

    copy_right: <>Full Copyright & Design By <Link href="#">@Devtekai</Link> – {new Date().getFullYear()}</>,
    ...
    footer_lisks : [
        {
            ...
            links: [
                ...
                {name: "Technology - Software Development", link: "#"},
                {name: "Technology - AI Solutions", link: "#"},  
                {name: "Business - Real Estate", link: "#"},                         
