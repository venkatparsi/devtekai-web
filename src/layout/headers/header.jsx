...
import logo from "../../../public/assets/img/logo/logo-black-tagline.svg"
import logoLight from "../../../public/assets/img/logo/logo-white-tagline.svg"
                     ...
                     <div className="row align-items-center">
                        <div className="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-6">
                           <div className="header-bottom__logo">
                              <Link href="/"><Image  src={logo} alt="" style={{maxWidth:"157px"}} /></Link>
                           </div>
                        </div>
