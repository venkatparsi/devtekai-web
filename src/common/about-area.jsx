...
const about_content = {
    title: "AI Solutions",
    sub_title: "We Offer  AI Data Solutions", 
    des: <>AI is rapidly becoming a major player in organizational growth prediction and diversification strategies, particularly within the service industry. Here's how AI can revolutionize these areas<br /></>,

    about_list: [
        <>Growth Prediction</>,
        <>Diversification Strategies</>,
        <>Efficient Customer Service (Minimal Costs).</>,
