...
const hero_content = {
    ...
    hero_title: <><span className='tp_title'><span className='child'>The Leading AI Platform</span></span> <br />
        {/* <span><span className='child'>AI Platform</span></span> </>, */}
        </>,
    sub_title: <>We are going to make sense of your data</>,
    hero_shape_img: [
        {
            id: 1,
            cls: "1",
